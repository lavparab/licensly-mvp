            ...
            <div>
                ...
                {alerts.length > 0 ? (
                    <div className="space-y-3">
                        {alerts.map(alert => (
                            <Card key={alert.id} className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-[#2e2e2e]">
                    ...
                    <Card className="flex flex-col items-center justify-center p-12 text-center border-dashed bg-white dark:bg-[#111111] dark:border-[#2e2e2e]">
            ...
            <div>
                ...
                {renewals.length > 0 ? (
                    <div className="space-y-2">
                        {renewals.map(lic => (
                            <Card key={lic.id} className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-[#2e2e2e]">
