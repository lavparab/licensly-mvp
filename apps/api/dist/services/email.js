...
exports.sendComplianceAlertEmail = sendComplianceAlertEmail;
const resend_1 = require("resend");
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
const resend = new resend_1.Resend(process.env.RESEND_API_KEY || 're_mock123'); // Fallback for MVP local dev
...
async function sendComplianceAlertEmail(to, severity, message) {
