...
export async function checkOrganizationCompliance(orgId: string) {
    try {
...
async function createAlert(orgId: string, licenseId: string, alertType: string, severity: string, message: string) {
